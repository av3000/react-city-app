                        ...
                        <React.Fragment>
                            ...
                            <div className="container">
                                ...
                                <div className="tab-content mb-5">
                                    {/* About Place Tab */}
                                    <div id="aboutPlace" className="tab-pane in active text-center mb-5" role="tabpane1">
                                        <h2 className="mb-3">{title}</h2>
                                        <p>{description}</p>
                                        <img src={img} alt={title} className="img-thumbnail img-fluid"/>
                                    </div>
                                    {/* Reviews */}
                                    <div className="tab-pane" id="reviews" role="tabpane2">
                                        <Reviews />
                                    </div>
                                    {/* Map */}
                                    <div className="tab-pane" id="map" role="tabpane3">
                                        <iframe 
                                            src={maps} 
                                            style={{ border: '0', height: "28.125rem", width: "100%", frameBorder: '0'}} ></iframe>
                                    </div>
                                </div>
                            </div>
                        </React.Fragment>
